document.addEventListener("DOMContentLoaded", () => {
  ...
  const loadingOverlay = document.getElementById("loadingOverlay"); // ✅ เพิ่ม loading overlay
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      loadingOverlay.style.display = "none"; // ✅ ซ่อน loading ไม่ว่าผลลัพธ์จะสำเร็จหรือไม่
    }
  });

  // บีบอัด + ใส่ timestamp
